...
const botAttackCooldown = 1000;  
    ...
    function updatePlayerImage() {
        ...
        // 2) Sinon si on se déplace, GIF de course
            ...
            player.style.backgroundImage = "url('run-unscreen.gif')";
            player.style.width = "240px";
            player.style.height = "240px";
        } 
        // 3) Sinon, image immobile
        else {
            player.style.backgroundImage = "url('stand-removebg-preview.png')";
    ...
    function doSlash() {
        ...
        player.style.backgroundImage = "url('slash-perso-unscreen.gif')";
        player.style.width = "240px";
        player.style.height = "240px";
...
// Vérifier la distance entre le joueur et le bot
 ...
 // Si la distance est < 80 px, le bot perd 1 PV
  if (distance < 80) {
       ...
       createBotHealthBar(); // Mise à jour de la barre de vie du bot
    ...
    function doBotSlash() {
        ...
        botElement.style.backgroundImage = "url('slash-perso-unscreen.gif')";
    ...
    function updateBotImage() {
        ...
        if (botIsMoving) {
            document.getElementById("bot").style.backgroundImage = "url('run-unscreen.gif')";
            document.getElementById("bot").style.width = "240px";
            document.getElementById("bot").style.height = "240px";
        } else {
            document.getElementById("bot").style.backgroundImage = "url('stand-removebg-preview.png')";
